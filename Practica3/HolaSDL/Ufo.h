...
public:
	Ufo() = default;
	Ufo(Point2D<> position, Texture* texture, GameState* game, bool direction, int state);
	Ufo(Point2D<> position, Texture* texture, GameState* game, bool direction, int state, int hT);
